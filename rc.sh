...
#Brittany Whitt: deleted the for loop and subsequent reverse command - are reolaced by the one liner below.

# new one liner to convert sequence into the reverse complement - started by Brittany Whitt
